...
class Config(object):
    ...
    # Send .get_id in any channel to fill this value. ReQuired for @LionPlugin
    # inspiration to work!
    ...
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "MadBoy")
    ...
    THUMB_IMAGE = os.environ.get,(
        "THUMB_IMAGE", "https://telegra.ph/file/64582793ebcf0838b3694.jpg"
    )
    ...
    UPSTREAM_REPO_URL = os.environ.get(
        "UPSTREAM_REPO_URL", "https://github.com/mdnoor786/lionuserbot.git"
    )
