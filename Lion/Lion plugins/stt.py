# speech to text module for lionuserbot by unievent.client(@spechide)
import os
    ...
    if event.reply_to_msg_id:
        ...
        if (
            ...
            if "results" in r:
                ...
                await lionevent.edit(r["error"])
            # now, remove the temporary file
            os.remove(required_file_name)
    else:
        await lionevent.edit("Reply to a voice message, to get the relevant transcript.")
