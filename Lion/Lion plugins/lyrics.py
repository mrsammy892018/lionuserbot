...
async def _(event):
    ...
    if event.pattern_match.group(1):
        ...
        await lionevent.edit("`What I am Supposed to find `")
        return
    song = ""
...
async def lyrics(lyric):
    ...
    try:
        ...
        songs = None
    if songs is None:
        await lionevent.edit(f"Song **{artist} - {song}** not found!")
        return
    if len(songs.lyrics) > 4096:
        await lionevent.edit("`Lyrics is too big, view the file to see it.`")
