...
from . import CMD_LIST, lionalive
...
if Config.TG_BOT_USER_NAME_BF_HER is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if query.startswith("**Lionuserbot") and event.query.user_id == bot.uid:
            buttons = [
                (
                    custom.Button.inline("Stats", data="stats"),
                    Button.url("Repo", "https://github.com/simpleboy786/lionuserbot"),
                )
            ]
            ...
            try:
                ...
                if u.username:
                    ...
                    mdnoor = f"[{u.first_name}](tg://user?id={u.id})"
                u = int(u.id)
            except:
                return
    ...
    async def on_plug_in_callback_query_handler(event):
        if event.query.user_id == bot.uid:  # pylint:disable=E0602
            ...
            reply_pop_up_alert = "Please get your own catuserbot, and don't use mine! Join @lionuserbot help"
    ...
    async def on_plug_in_callback_query_handler(event):
        if event.query.user_id == bot.uid:
            ...
            reply_pop_up_alert = "Please get your own lionuserbot, and don't use mine! Join @lionuserbot help "
            await event.answer(reply_pop_up_alert, cache_time=0, alert=True)
