# lionuserbot Google Drive managers  ported from Projectbish and added extra things by @mrconfused
...
async def copy_dir(service, file_id, dir_id):
    ...
    for file in files:
        if file["mimeType"] == "application/vnd.google-apps.folder":
            ...
            liondir_id = folder.get("id")
            new_id = await copy_dir(service, file["id"], liondir_id)
        else:
